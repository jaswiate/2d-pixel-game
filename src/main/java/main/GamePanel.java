...
public class GamePanel extends JPanel implements Runnable {
    ...
    Player player = new Player(pos, 100, 2, 3, this, keyHandler);
    ...
    Level currentLevel = level22;
    List<Monster> currentMonsters = monsters22;
    List<Entity> currentCollectibles = collectibles22;
